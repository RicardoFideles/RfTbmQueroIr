		...
		<table cellpadding="0" cellspacing="0" border="0" class="stdtable" id="dyntable">
			...
			<thead>
				<tr>
					...
					<th class="head1"><?php echo $this->Paginator->sort('Blog');?></th>
			...
			<tbody>
				<?php foreach ($blogs as $blog): ?>
					<tr class="gradeX">
						...
						<td class="center">
							<?php echo $this->Html->link(__('Editar'), array('action' => 'edit', $blog['Blog']['id'])); ?>
							<?php echo $this->Form->postLink(__('Apagar'), array('action' => 'delete', $blog['Blog']['id']), null, __('Você tem certeza que deseja apagar # %s?', $blog['Blog']['name'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
			</tbody>

...
<script type="text/javascript"
   src="<?php echo $this->Html->url('/js/tiny_mce/plugins/tinybrowser/tb_tinymce.js.php'); ?>"></script>
...
<script type="text/javascript">
	jQuery().ready(function() {
		jQuery('textarea').tinymce({
			...
			theme_advanced_buttons3 : "hr,removeformat,|,sub,sup,|,charmap,iespell,media,advhr,|,fullscreen",

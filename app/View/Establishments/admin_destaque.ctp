...
<div class="content">
	<ul class="buttonlist">
		<?php foreach($cidades as $key => $cidade): ?>
			...
			<li>
				<a href="<?php $link = array('controller' => 'establishments', 'action' => 'lista', $id_cidade, null);echo $this->Html->url($link); ?>" class="btn btn_book">
					<span>Filtrar por <?php echo $cidade['City']['name']; ?></span>
				</a>
			</li>
		<?php endforeach; ?>
	</ul>
	<div class="contenttitle radiusbottom0">
		<h2 class="table"><span>Estabelecimentos em Destaque</span></h2>
	</div>
